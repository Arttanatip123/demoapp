                                  ...
                                  children: [
                                    Container(
                                      ...
                                      children: [
                                        ...
                                        new Text(
                                            "${soon[index]["date_begin"]} ${soon[index]["month_begin"]} - ${soon[index]["date_end"]} ${soon[index]["month_end"]} ${soon[index]["year"]}",
                                            style: TextStyle(
