...
baseResponseDataFromJson(BaseResponseData data, Map<String, dynamic> json) {
  if (json['order_id'] != null) {
    data.orderId =
        json['order_id'] is String ? int.tryParse(json['order_id']) : json['order_id'].toInt();
  }
...
dataUploadFromJson(DataUpload data, Map<String, dynamic> json) {
  ...
  if (json['width'] != null) {
    data.width = json['width'] is String ? int.tryParse(json['width']) : json['width'].toInt();
  }
  if (json['height'] != null) {
    data.height = json['height'] is String ? int.tryParse(json['height']) : json['height'].toInt();
  }
  if (json['mime'] != null) {
